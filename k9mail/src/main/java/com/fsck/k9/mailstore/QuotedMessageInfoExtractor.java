...
public class QuotedMessageInfoExtractor implements MessageInfoExtractor<QuotedMessageInfo> {
    ...
    private QuotedMessageInfoExtractor(MessageFormat requestedMessageFormat, boolean shouldStripSignature,
            QuoteStyle quoteStyle, String quotePrefix) {
    ...
    public static MessageInfoExtractor<QuotedMessageInfo> getInstance(MessageFormat requestedMessageFormat,
            boolean shouldStripSignature, QuoteStyle quoteStyle, String quotePrefix) {
        return new QuotedMessageInfoExtractor(requestedMessageFormat, shouldStripSignature, quoteStyle, quotePrefix);
    }

    @WorkerThread
    public QuotedMessageInfo extractMessageInfo(Context context,  Message message,
        ...
        MessageViewInfo messageViewInfo =
                MessageViewInfoExtractor.getInstance().extractMessageInfo(context, message, annotations);
